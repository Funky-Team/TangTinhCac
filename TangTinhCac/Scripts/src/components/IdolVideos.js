                            ...
                            <div className="row d-flex justify-content-center">
                                <div className="single-film wow fadeInDown col-md-4" data-wow-delay=".1s">
                                    <div className="box" style=
                                        ...
                                        <i className="video-tag-close glyphicon glyphicon-remove-circle" onclick="pauseVid1()"></i>
                                    </div>
                                ...
                                <div className="single-film wow fadeInDown col-md-4" data-wow-delay=".2s">
                                    <div className="box" style=
                                        ...
                                        <i className="video-tag-close glyphicon glyphicon-remove-circle" onclick="pauseVid2()"></i>
                                    </div>
                                    <div className="film-information">
                                        <p>Big Buck Bunny</p>
                                        <p>Video Gallery 2</p>
                                ...
                                <div className="single-film wow fadeInDown col-md-4" data-wow-delay=".3s">
                                    <div className="box" style=
                                        ...
                                        <div className="play-video">
                                            ...
                                            <i className="video-tag-close glyphicon glyphicon-remove-circle" onclick="pauseVid3()"></i>
                                        </div>
                                    </div>
                                    <div className="film-information">
                                        <p>Big Buck Bunny</p>
                                ...
                                <div className="single-film wow fadeInDown col-md-4" data-wow-delay=".4s">
                                    <div className="box" style=
                                        ...
                                        <div className="play-video">
                                            ...
                                            <i className="video-tag-close glyphicon glyphicon-remove-circle" onclick="pauseVid4()"></i>
                                        </div>
                                    </div>
                                    <div className="film-information">
                                        <p>Big Buck Bunny</p>
                                ...
                                <div className="single-film wow fadeInDown col-md-4" data-wow-delay=".5s">
                                    <div className="box" style=
                                        ...
                                        <div className="play-video">
                                            ...
                                            <i className="video-tag-close glyphicon glyphicon-remove-circle" onclick="pauseVid5()"></i>
                                        </div>
                                    </div>
                                    <div className="film-information">
                                        <p>Big Buck Bunny</p>
                                ...
                                <div className="single-film wow fadeInDown col-md-4" data-wow-delay=".6s">
                                    <div className="box" style=
                                        ...
                                        <div className="play-video">
                                            ...
                                            <i className="video-tag-close glyphicon glyphicon-remove-circle" onclick="pauseVid6()"></i>
                                        </div>
                                    </div>
                                    <div className="film-information">
                                        <p>Big Buck Bunny</p>
